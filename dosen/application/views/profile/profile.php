				...
				<div class="box" style="border-radius: none; border-top: none;">
					<div class="box-body box-profile">
						<div class="row">
							<div class="col-md-4">
								<?php 
								if(isset($dsn_id['foto']))
								{
									$foto = base_url('upload/'.$dsn_id['foto'] );
								}
								else 
								{
							...
							<div class="col-md-8">
								<h3 class="profile-username text-center"><?= ucwords($dsn_id['nama_lkp']) ?></h3>

								<p class="text-muted text-center"><?= $dsn_id['prodi_nama'] ?></p>
								...
								<p class="text-muted">
									<?= $dsn_id['jk'] == "L" ? "Laki-Laki" : "Perempuan" ?>
								</p>
								...
								<p class="text-muted">
									<?= $dsn_id['no_telp'] != "" ? $dsn_id['no_telp'] : "<br>" ?>
								</p>
								...
								<p class="text-muted">
									<?= $dsn_id['alamat_lkp'] != "" ? $dsn_id['alamat_lkp'] : "<br>" ?>
								</p>
