		...
		<div class="row">
			<div class="col-sm-8">
				...
				<div class="box" style="border-radius: none; border-top: none;">
					<div class="box-body">
						<h3><i>Hai</i>, <b><?= ucwords($dsn_id['nama_lkp']) ?></b>, Sebelum memulai ada baiknya anda melihat pedoman terlebih dahulu di sini <a class="fa fa-external-link" href="<?= site_url('pedoman') ?>"></a>
						</h3> 
					</div> <!-- /.box-body -->
				</div> <!-- /.box -->
			</div> <!-- /.col-sm-8 -->
