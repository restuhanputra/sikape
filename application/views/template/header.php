        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li class=""><a href="<?= site_url('home') ?>">HOME</a></li>
						<li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">KERJA PRAKTEK <span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a href="<?= site_url('kerja_praktek') ?>">FORM KERJA PRAKTEK</a></li>
                <li><a href="<?= site_url('kerja_praktek/riwayat_kerja_praktek') ?>">RIWAYAT PENGAJUAN FORM KERJA PRAKTEK</a></li>
              </ul>
            </li>
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown notifications-menu">
								<?php
								if($this->fu->notif()['notif'] == 2)
								{
									$notif   = $this->fu->notif()['notif'] - 1;
									$text    = "Anda mendapatkan notifikasi";
									$content = "Pengajuan anda telah diverifikasi";
								}
								else 
								{
									$notif   = "";
              ...
              <ul class="dropdown-menu">
                  ...
                  <ul class="menu">
                    <li><!-- start notification -->
							<?php if(empty($content)) 
										...
										{
							?>
											<a href="<?= site_url('magang/riwayat_magang') ?>"><?= $content ?></i></a>
							<?php
										} ?>
                ...
                <li class="footer"><a href="<?= site_url('magang/riwayat_magang') ?>">Lihat</a></li>
              </ul>
            </li>
