		...
		<div class="box" style="border-radius: none; border-top: none;">
			...
			<ul class="info news-items" style="padding-right:30px; padding-bottom:10px;">
				...
				if (isset($info))
				{
					...
					<li>
						<div class="news-item-date"><span class="news-item-day"><?= date('d', strtotime($data['created'])); ?></span> <span class="news-item-month"><?= date('M', strtotime($data['created'])); ?></span> <span class="news-item-year"><?= date('Y', strtotime($data['created'])); ?></span></div>
