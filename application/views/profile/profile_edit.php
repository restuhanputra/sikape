					...
					<div class="box-body">
						<form class="form" action="<?= site_url('profile/edit') ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" name="nama_lkp" placeholder="Nama Legkap" value="<?= $mhs_id['nama_lkp'] ?>" readonly>
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" name="agama" placeholder="Agama" value="<?= $mhs_id['agama_nama'] ?>" readonly>
							...
							<div class="form-group row <?= form_error('alamat_lkp') ? 'has-error' : null ?>">
								...
								<div class="col-sm-8">
									<textarea class="form-control" rows="5"  name="alamat_lkp" placeholder="Alamat Lengkap"><?= $mhs_id['alamat_lkp'] != "" ? $mhs_id['alamat_lkp'] : "" ?></textarea>
