			...
			<form>
				<div class="box-body">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="email" class="form-control" name="email" placeholder="Email" value="<?= $mhs_id['email'] != ""? $mhs_id['email'] : "" ?>" readonly>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="dosen_pa" placeholder="Dosen P.A" value="<?= $mhs_id['dpa_nama'] ?>" readonly>
						</div>
					</div>
					<div class="form-group row">
