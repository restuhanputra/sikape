		...
		<div class="col-xs-12">
			...
			<form>
				<div class="box-body">
					...
					<div class="form-group row">
						<label for="doesn_pa" class="col-sm-4 control-label">ID Dosen P.A</label>

						<div class="col-sm-8">
							<input type="text" class="form-control" name="doesn_pa" placeholder="doesn_pa" value="<?= $dsn_id['dpa_id'] != 0 ? $dsn_id['dpa_id'] : "TIDAK TERDAFTAR" ?>" readonly>
