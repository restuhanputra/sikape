	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class='box-header with-border'>
				<h3 class='box-title'>
				<a href="<?= site_url('admin/add') ?>" class="btn btn-sm btn-primary"><i class='fa fa-plus'></i> Tambah Data</a>
				</h3>
			</div><!-- /.box-header -->
							...
							<tr>
								...
								<td class="text-center">
									<form action="<?= site_url('admin/delete') ?>" method="post">
										...
										<button onclick="return confirm('Apakah anda yakin ?')" href="<?= site_url('dosen/delete') ?>" class="btn btn-sm btn-flat btn-danger"> <i class="fa fa-trash"></i></button>
									</form>
								</td>
							</tr>
						<!-- /. Isi Tabel -->
